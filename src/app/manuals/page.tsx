...
export default function ManualsIndex() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <h1 className="text-4xl font-semibold tracking-tight">Field manuals</h1>
      ...
      <div className="mt-6">
        <Link
          href="/manuals/new"
          className="inline-flex items-center justify-center rounded-full bg-ink px-4 py-2 text-sm font-medium text-bg transition hover:bg-white"
        >
          Write your own
        </Link>
      </div>
