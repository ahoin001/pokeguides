...
export function TypePlayground({ seed = "fire" }: { seed?: TypeId }) {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="rounded-[28px] border border-line bg-raised/40 px-6 py-8 md:px-10 md:py-10">
        {defend.length ? (
          <div className="space-y-8">
            ...
            <p>
              <span className="block font-mono text-4xl font-semibold tracking-tight md:text-5xl">{multLabel}</span>
