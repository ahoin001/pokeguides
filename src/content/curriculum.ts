...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    body: [
      "Most abilities are flavor. These are not. Treat this page as a reference sheet: what the ability does, how you counter it, and who often carries it.",
      "On preview, name the dangerous abilities on their list. The turn an ability reveals, write it down. Flash Fire is not Flame Body. Cursed Body is not Levitate.",
    ],
    rules: [
      { label: "Does", detail: "What the ability actually changes on the turn." },
      { label: "Counter", detail: "How you play around it — types, moves, switches, or ignores." },
      { label: "Faces", detail: "Ranked names that often pack it. Species alone is not the reveal." },
      { label: "Contact trap", detail: "Cursed Body, Flame Body, Static, Rough Skin punish contact clicks." },
    ...
    beats: [
      {
        title: "Intimidate",
        body: "On switch-in, Intimidate lowers the opponent’s Attack one stage. That tax lasts for the rest of the send — every physical hit they throw is weaker. Special attackers ignore the drop entirely. Mirror Armor bounces the drop back; Clear Body and similar ignore it.",
        takeaway: "If their wincon is physical, Intimidate on the list is a preview sentence. Answer with specials, Mirror Armor, or Clear Body — do not gift your Band cleaner for free.",
        rows: [
          { label: "Does", detail: "On entry, −1 Attack to the opposing Pokémon currently in." },
          { label: "Why", detail: "Free physical tax every send. Slows Choice Band trucks and Dance sweepers." },
          { label: "Counter", detail: "Special attackers shrug. Mirror Armor bounces it. Clear Body / Full Metal Body ignore it. Do not hard-switch your physical cleaner into the tax." },
        ],
        example: { slug: "incineroar", caption: "Intimidate — format switch-in tax." },
        examples: [
          { slug: "salamence", caption: "Intimidate #1 face" },
          { slug: "incineroar", caption: "Fake Out + Intimidate" },
          { slug: "gyarados", caption: "Intimidate pivot" },
          { slug: "mawile", caption: "Intimidate Mega seat" },
          { slug: "arcanine", caption: "Intimidate / Extreme Speed" },
          { slug: "staraptor", caption: "Intimidate lead" },
        ],
      },
      {
        title: "Disguise",
        body: "Disguise blocks the first damaging hit — the costume breaks, HP does not. Status, weather, and some indirect chip do not always spend it like a nuke. After it breaks, Mimikyu is ordinary. The free hit is usually a Swords Dance or safe pivot.",
        takeaway: "Knock the costume once, then punish the setup. Do not farm chip into a Dance.",
        rows: [
          { label: "Does", detail: "Negates the first damaging hit; then Disguise is gone for the battle." },
          { label: "Why", detail: "Buys a Dance, a free hit, or a pivot behind the costume." },
          { label: "Counter", detail: "Mold Breaker ignores it. Fake Out then follow up. Status and hazards pressure. Hit once, then answer the boosted mon." },
        ],
        example: { slug: "mimikyu-disguised", caption: "Disguise — only Mimikyu. One free hit." },
        examples: [{ slug: "mimikyu-disguised", caption: "Disguise (Mimikyu only)" }],
      },
      {
        title: "Multiscale",
        body: "From full HP, Multiscale halves the first hit the user takes. Any prior chip — Stealth Rock on the switch, residual — turns it off. Once HP is not full, Multiscale stays offline.",
        takeaway: "Chip before the nuke. Rocks on the switch are enough.",
        rows: [
          { label: "Does", detail: "Halves damage from the first hit while at full HP." },
          { label: "Why", detail: "Lives revenge or buys a Dragon Dance from full." },
          { label: "Counter", detail: "Stealth Rock or any chip first. Mold Breaker ignores it. Fake Out then the real hit. Do not click the OHKO into full Multiscale." },
        ],
        example: { slug: "dragonite", caption: "Multiscale — the main full-HP wall." },
        examples: [{ slug: "dragonite", caption: "Multiscale (main face)" }],
      },
      {
        title: "Prankster",
        body: "Prankster gives +1 priority to status moves only — Tailwind, Thunder Wave, Taunt, Encore, Will-O-Wisp. Damaging moves are unchanged. Fake Out (+3) still beats Prankster Tailwind. Dark types are immune to Prankster status aimed at them; side-targeting moves like Tailwind still go up.",
        takeaway: "Prankster is +1 on support. Fake Out still wins the lead race. Dark blanks Taunt and Encore.",
        rows: [
          { label: "Does", detail: "+1 priority on status moves. Does not speed up attacks." },
          { label: "Why", detail: "Sets Tailwind, Taunt, Encore, or Wave before most attacks resolve." },
          { label: "Counter", detail: "Fake Out the setter. Dark blanks Prankster status at them. Taunt first if you outspeed the +1. Knock the clock before Tailwind inherits." },
        ],
        example: { slug: "whimsicott", caption: "Prankster — +1 Tailwind / Taunt / Encore." },
        examples: [
          { slug: "whimsicott", caption: "Prankster clock" },
          { slug: "grimmsnarl", caption: "Prankster screens" },
          { slug: "sableye", caption: "Prankster disrupt" },
          { slug: "klefki", caption: "Prankster support" },
          { slug: "banette-mega", caption: "Prankster Mega" },
        ],
      },
      {
        title: "Cursed Body",
        body: "When a move makes contact, there is a chance the attacker’s move becomes Disabled for several turns. The hit still deals damage — the trap is losing Extreme Speed, Fake Out, or STAB next turn. It is not an immunity like Flash Fire or Levitate.",
        takeaway: "Contact into Cursed Body can erase the button you needed. Prefer specials or non-contact when the Ghost is known.",
        rows: [
          { label: "Does", detail: "On contact, chance to Disable the move that just connected." },
          { label: "Why", detail: "Punishes Fake Out, Extreme Speed, Close Combat, and contact STAB loops." },
          { label: "Counter", detail: "Non-contact damage (specials, many coverage moves). Status from range. Protect / switch. Finish with a different move if Disable lands. Do not Autopilot contact into Gengar / Banette / Froslass." },
        ],
        example: { slug: "gengar", caption: "Cursed Body — contact can Disable STAB." },
        examples: [
          { slug: "gengar", caption: "Cursed Body" },
          { slug: "banette", caption: "Cursed Body / Bond" },
          { slug: "froslass", caption: "Cursed Body" },
          { slug: "dragapult", caption: "Often Ghost seat — check ability" },
        ],
      },
      {
        title: "Flame Body · Static · Poison Point",
        body: "Contact can inflict status on the attacker: Flame Body burns (−Atk physicals + residual), Static paralyzes (Speed cut + full para chance), Poison Point poisons. Effect Spore can sleep, poison, or paralyze. The attack still hits — you paid with status. Read the reveal: Talonflame Flame Body is not Chandelure Flash Fire.",
        takeaway: "Known Flame Body / Static → prefer non-contact or status from range. Fake Out into Flame Body is how cleaners donate burn.",
        rows: [
          { label: "Does", detail: "Contact may burn (Flame Body), para (Static), poison (Poison Point), or Effect Spore status." },
          { label: "Why", detail: "Soft-walls physical pressure without spending a Will-O-Wisp turn." },
          { label: "Counter", detail: "Non-contact damage. Special attackers. Status / Taunt from range. Protect. Switch. Do not spam contact into a known Flame Body lead." },
        ],
        example: { slug: "talonflame", caption: "Flame Body — contact burn tax." },
        examples: [
          { slug: "talonflame", caption: "Flame Body" },
          { slug: "chandelure", caption: "Flame Body (alt vs Flash Fire)" },
          { slug: "raichu", caption: "Static" },
          { slug: "pikachu", caption: "Static" },
          { slug: "manectric", caption: "Static / Lightning Rod" },
          { slug: "roserade", caption: "Poison Point" },
          { slug: "clodsire", caption: "Poison Point / Unaware" },
        ],
      },
      {
        title: "Rough Skin",
        body: "Contact into Rough Skin chips the attacker. The hit still lands — every Fake Out, Extreme Speed, and multi-hit contact pays residual. Rocky Helmet stacks make contact a losing trade. Iron Barbs works the same way when present.",
        takeaway: "Into Rough Skin (especially Garchomp), prefer specials or non-contact when the race is close.",
        rows: [
          { label: "Does", detail: "Contact deals residual damage back to the attacker." },
          { label: "Why", detail: "Punishes priority contact and physical spam over a short game." },
          { label: "Counter", detail: "Special attacks. Non-contact coverage. Status. Knock Off if Rocky Helmet is paired. Do not chip yourself out with Extreme Speed loops." },
        ],
        example: { slug: "garchomp", caption: "Rough Skin — #2 contact tax." },
        examples: [
          { slug: "garchomp", caption: "Rough Skin (common)" },
          { slug: "sharpedo", caption: "Rough Skin" },
        ],
      },
      {
        title: "Armor Tail",
        body: "Armor Tail makes priority moves aimed at the user fail — Fake Out, Extreme Speed, Aqua Jet, Sucker Punch, Grassy Glide, and similar. Non-priority attacks and most status still work. Farigiraf uses it so Trick Room can go up without eating lead flinch.",
        takeaway: "Fake Out into Armor Tail is a blank turn. Plan the Farigiraf lead without relying on priority.",
        rows: [
          { label: "Does", detail: "Priority moves targeting this Pokémon fail." },
          { label: "Why", detail: "Protects Trick Room / support from Fake Out and revenge priority." },
          { label: "Counter", detail: "Attack at normal priority. Taunt. Thunder Wave / status. KO or pressure before the room. Do not open Fake Out into Farigiraf." },
        ],
        example: { slug: "farigiraf", caption: "Armor Tail — Fake Out fails." },
        examples: [{ slug: "farigiraf", caption: "Armor Tail (main face)" }],
      },
      {
        title: "Mold Breaker",
        body: "Your moves ignore the target’s ability when the hit resolves. Multiscale, Disguise, Levitate, Flash Fire, and similar soft walls do not apply. It does not boost power by itself — it removes their safety net.",
        ...
        rows: [
          ...
          { label: "Why", detail: "Breaks Multiscale, Disguise, Levitate, Flash Fire soft walls." },
          { label: "Counter", detail: "Do not hide behind those abilities vs Excadrill / Tinkaton. Resist the type, Protect, or KO the Mold Breaker first." },
        ],
        example: { slug: "excadrill", caption: "Mold Breaker — soft walls fail." },
        examples: [
      ...
      {
        title: "Unaware",
        body: "Unaware ignores the opponent’s Attack and Defense stage boosts in damage involving you — their Swords Dance does not hit harder into you the same way, and their Defense stacks do not blunt your attacks the same way. It does not ignore Speed, SpD, or the type chart.",
        takeaway: "Setup is not a wincon into Unaware. Speed, status, and SpD races still are.",
        rows: [
          { label: "Does", detail: "Ignores foe Atk/Def boosts when calculating damage with the Unaware user." },
          { label: "Why", detail: "Hard-stops Dance and Defense-stacking walls." },
          { label: "Counter", detail: "Outspeed and status. Special into SpD. Phaze / Haze. Do not keep stacking Attack into Skeledirge or Clefable." },
        ],
        example: { slug: "skeledirge", caption: "Unaware — Dance does not count." },
        examples: [
          { slug: "skeledirge", caption: "Unaware wall" },
          { slug: "clefable", caption: "Unaware / Magic Guard" },
          { slug: "dondozo", caption: "Unaware tank" },
          { slug: "clodsire", caption: "Unaware / Water Absorb" },
        ],
      },
      {
        title: "Drizzle",
        body: "Drizzle sets rain on entry. Water strengthens, Fire weakens, Thunder and Hurricane never miss, Swift Swim doubles Speed. The ability is the team — partners cash the field. Drought or sand overwrite ends the package.",
        takeaway: "No Drizzle setter usually means no rain. Plan the lead as if Pelipper is coming.",
        rows: [
          { label: "Does", detail: "Sets rain when the user enters." },
          { label: "Why", detail: "Enables Swift Swim, Electro Shot, accurate Hurricane, Water offense." },
          { label: "Counter", detail: "Sun or sand overwrite. KO the setter. Resist Water. Play Speed as if rain can end mid-game." },
        ],
        example: { slug: "pelipper", caption: "Drizzle — rain on entry." },
        examples: [
          { slug: "pelipper", caption: "Drizzle (main)" },
          { slug: "politoed", caption: "Drizzle / Perish" },
        ],
      },
      {
        title: "Drought",
        body: "Drought sets harsh sunlight on entry. Fire strengthens, Water weakens, Chlorophyll doubles Speed, Growth jumps. Mega stones that grant Drought make the item and the field the same wincon.",
        takeaway: "Drought on the list = play sun until the setter or Mega is gone.",
        rows: [
          { label: "Does", detail: "Sets sun when the user enters." },
          { label: "Why", detail: "Fire nukes, Chlorophyll racers, Growth stacks." },
          { label: "Counter", detail: "Rock and Water resists. Rain overwrite. KO the Drought setter / Mega." },
        ],
        example: { slug: "charizard-mega-y", caption: "Drought Mega — field + nuke." },
        examples: [
      ...
      {
        title: "Grassy Surge",
        body: "Grassy Surge sets Grassy Terrain on entry. Grounded Pokémon heal each turn, Earthquake softens, Grassy Glide becomes +1 priority. Without terrain, Glide is just a slow Grass move.",
        takeaway: "No Grassy Surge, no Grassy room. Remove or overwrite before you race Glide.",
        rows: [
          { label: "Does", detail: "Sets Grassy Terrain on entry." },
          { label: "Why", detail: "Residual heal, priority Grassy Glide, softer Earthquake." },
          { label: "Counter", detail: "Overwrite terrain. Flying / Levitate ignore grounded rules. Resist Grass. Fake Out or KO Rillaboom." },
        ],
        example: { slug: "rillaboom", caption: "Grassy Surge — terrain on entry." },
        examples: [{ slug: "rillaboom", caption: "Grassy Surge (main)" }],
      },
      {
        title: "Flash Fire",
        body: "Flash Fire grants immunity to Fire moves and powers up the user’s Fire attacks after absorbing one. The predicted Fire STAB becomes a wasted turn and their boost. Other abilities on the same species (Flame Body, Weak Armor) play completely differently — note the reveal.",
        takeaway: "Do not click Fire into Flash Fire. Species alone is not enough — wait for the ability text.",
        rows: [
          { label: "Does", detail: "Immune to Fire; absorbing Fire powers up the user’s Fire moves." },
          { label: "Why", detail: "Punishes Fire STAB and Torch Song / Flare Blitz on the switch." },
          { label: "Counter", detail: "Hit with anything but Fire. Mold Breaker ignores it. Status and coverage. Do not Autopilot Fire into Ceruledge / Chandelure." },
        ],
        example: { slug: "ceruledge", caption: "Flash Fire — Fire clicks fail." },
        examples: [
          { slug: "ceruledge", caption: "Flash Fire" },
          { slug: "chandelure", caption: "Flash Fire (or Flame Body)" },
        ],
      },
    ],
    examples: [
