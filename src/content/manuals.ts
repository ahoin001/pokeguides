...
export const CANONICAL_MANUALS: TeamManual[] = [
  ...
  },
  {
    ...
    philosophy:
      "Stranglehold, not a wall. You traded Corvi's U-turn for Intimidate, Fake Out, Fire STAB, and Parting Shot. Parting Shot is −6: they hit the cat, then Garchomp is in.",
    archetype: "balance",
    ...
    slots: [
      ...
      },
      {
        ...
        moves: [
          ...
          { name: "Knock Off", why: "Ghost (Fake Out blank) and items. Do not Knock Off Tinkaton." },
        ],
    ...
    phases: [
      ...
      },
      {
        ...
        branches: [
          ...
          { when: "Cat out into Ghost", then: "Knock Off or Parting Shot. Never Fake Out." },
      ...
      },
      {
        ...
        branches: [
          ...
          { when: "Gholdengo in", then: "Fake Out and Knock Off. Parting Shot fails." },
    ...
    hazards: [
      ...
      { title: "Ghost, Cloak, Good as Gold", body: "Fake Out fails on Ghost. Cloak keeps their turn. Gholdengo blanks Parting Shot." },
